 ...
 */
public class BinaryTreeSerializeBFS {
    ...
    public String serialize(TreeNode root) {
        ...
        while (!queue.isEmpty()) {
            ...
            if (node == null && isValid > 0) {
                retval.append("None").append(delimiter);
                queue.add(null);
                queue.add(null);
                continue;
            } else if (node == null) {
            ...
            retval.append(node.val).append(delimiter);
            isValid--;
        ...
        retval.delete(retval.lastIndexOf(delimiter), retval.lastIndexOf(delimiter)+1);
    ...
    public TreeNode deserialize(String[] data, int i) {
        ...
        if ((2 * i + 1) < data.length && !data[2 * i + 1].equals("None")) {
            root.left = deserialize(data, 2 * i + 1);
        }

        if ((2 * i + 2) < data.length && !data[2 * i + 2].equals("None")) {
            root.right = deserialize(data, 2 * i + 2);
        }
    ...
    public static void main(String[] args) {
        BinaryTreeSerializeBFS bts = new BinaryTreeSerializeBFS();
//        BinaryTreeSerialize.TreeNode root = new BinaryTreeSerialize.TreeNode(5);
//        BinaryTreeSerialize.TreeNode node2 = new BinaryTreeSerialize.TreeNode(2);
//        BinaryTreeSerialize.TreeNode node3 = new BinaryTreeSerialize.TreeNode(3);
//        BinaryTreeSerialize.TreeNode node4 = new BinaryTreeSerialize.TreeNode(2);
//        BinaryTreeSerialize.TreeNode node5 = new BinaryTreeSerialize.TreeNode(4);
//
//        BinaryTreeSerialize.TreeNode node6 = new BinaryTreeSerialize.TreeNode(3);
//        BinaryTreeSerialize.TreeNode node7 = new BinaryTreeSerialize.TreeNode(1);
//
//        root.left = node2;
//        root.right = node3;
//        node3.left = node4;
...
//        node4.right = node7;
        ...
        TreeNode root = bts.deserialize(strs, 0);

        long start = System.currentTimeMillis();
        String str = bts.serialize(root);
        System.out.println(str);
        TreeNode node = bts.deserialize(str);
        System.out.println(bts.serialize(node));
